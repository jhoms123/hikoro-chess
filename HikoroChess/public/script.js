document.addEventListener('DOMContentLoaded', () => {
    ...
    function formatTime(seconds, inByoyomi) {
        if (seconds === -1) {
            return "∞";
        }
    ...
    function updateTimerDisplay(times) {
        ...
        whiteTimerEl.textContent = formatTime(whiteTime, isInByoyomiWhite);
        blackTimerEl.textContent = formatTime(blackTime, isInByoyomiBlack);
